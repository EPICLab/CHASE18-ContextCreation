...
Programming does not occur in isolation. It involves the programmer ideating and exploring different solutions and using different types of information---some from the code base, others from on line or external resources---to complete the task at hand. These relevant yet separate pieces of information along with the programmer's prior knowledge creates a context that the programmer uses to solve the task.  
