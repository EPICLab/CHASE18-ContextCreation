...
Context, while an intuitive concept, is very hard to define due to its highly dynamic nature. Schilit and Theimer~\cite{Schilit:1994b} defined context in the ``context-aware'' computing domain as being various factors of a user; such as location, time, and identity. 
